$(document).ready(function()
{
				...
				success : function(hasil){
								...
								{
								$("#masuk").html('Masuk');
								$("#notif").html('<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button>Wrong Username or Password ! </div>');
								return false;
								}
							},
					});
			...
			success : function(hasil){
							if(hasil=="ada")
							{
							$("#dnotif").html('<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button> this account are registered ! </div>');
							return false;	
							}
							else if(hasil=="yes")
							{
							$("#dnotif").html('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>Register Success, Please wait ! <img src="alihkan.gif" width="30px" height="30px"></div>');
								function alihkan()
								{
								document.location="index.php";
								}
							...
							{
							$("#dnotif").html('<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button> Register Failed ! </div>');
							return false;
							}
						},
				});
